...
#include "kmz_core.h"
#define assert_image_type() assert(KmzImage__get_type(me) == _KMZ_CORE_STD_IMAGE_TYPE && me->get_type == _KmzCoreStdImage__get_type /* Expected image type was not encountered */);
#define assert_matrix_type() assert(KmzMatrix__get_type(me) == _KMZ_CORE_STD_MATRIX_TYPE && me->get_type == _KmzCoreStdMatrix__get_type /* Expected matrix type was not encountered */);
...
size_t _KmzCoreStdImage__has_argb_buffer(KmzImage * me) {
    return 1;
}

kmz_color_32 * _KmzCoreStdImage__get_argb_buffer(KmzImage * me) {
    assert_image_type();
    _KmzCoreStdImage * this = (void*)me;
...
kmz_color_32 _KmzCoreStdImage__get_argb_at(KmzImage * me, kmz_point point) {
    assert_image_type();
    assert(KmzImage__is_valid(me, point) /* Invalid point provided */);
    _KmzCoreStdImage * this = (void*)me;
...
static const KmzImage _KmzCoreStdImage__methods = {
    ...
    .has_argb_buffer=&_KmzCoreStdImage__has_argb_buffer,
    .get_argb_buffer=&_KmzCoreStdImage__get_argb_buffer,
